// https://github.com/lkankowski/arduino-multi-relay/blob/master/README.md
//
...
RelayButton myRelayButtons[] = {
  {191, 2, 13, RELAY_TRIGGER_HIGH, MONO_STABLE, "Living room light 1"},  // WŁ: Ł2
  {192, 25, 16, RELAY_TRIGGER_HIGH, MONO_STABLE, "Sons room light 2"},  // WŁ: Salon prawy
};
...
void presentation() {
  ...
  sendSketchInfo("Rooms Lights", "1.3");
